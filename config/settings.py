...
# ── Data source ────────────────────────────────────────────────────────────────
# Set DATA_SOURCE to "kaggle" to use real Corporación Favorita CSVs, or
# "synthetic" to use the dataset generated by src/00_generate_synthetic_data.py.
#
# When DATA_SOURCE = "kaggle", also set KAGGLE_DATA_PATH to the folder that
# contains train.csv, stores.csv, items.csv, and holidays_events.csv.
